...
Ajax.post(
  ...
  function (res) {
    ...
    function pageConfigParse() {
      ...
      // console.log(globalConfig.authType); //11
      switch (globalConfig.authType) {
        case 0:
          window.authType = 0;
          break;
        case 1:
          document.getElementById("input-simple").style.display =
            "block";
          window.authType = 1;
          break;
        case 2:
        ...
        case 15:
          ...
          break;
        case 7:
          document.getElementById("button-facebook").style.display =
            "block";
          document
          ...
          document.getElementById("button-login").style.display =
            "none";
          window.authType = 7;
          break;
        case 11:
          document.getElementById("hotspot-section").style.display =
            "none";
          var options = "";
          for (var i = 0; i < globalConfig.hotspotTypes.length; i++) {
            // console.log('hotspot type', globalConfig.hotspotTypes[i]); //only one 3
            options +=
              '<option value="' +
          ...
          document.getElementById("hotspot-selector").innerHTML =
            options;
          // console.log('before hotspot change', globalConfig.hotspotTypes[0]);
          hotspotChang(globalConfig.hotspotTypes[0]);
          window.authType = globalConfig.hotspotTypes[0];
          // console.log('window auth type', window.authType);
          break;
      }
    }
    ...
    function handleSubmit() {
      var submitData = {};
      submitData["authType"] = window.authType; //3
      switch (window.authType) {
        ...
        case 8:
          ...
          break;
        case 15:
          submitData["ldapUsername"] =
            document.getElementById("username").value;
          submitData["ldapPassword"] =
            document.getElementById("password").value;
          break;
        default:
          break;
          ...
          Ajax.post(
            ...
            function (data) {
              ...
              if (!!data && data.errorCode === 0) {
                ...
                // additional client
                clientData["voucher"] = submitData["voucherCode"];
                clientData["mac_address"] = submitData["clientMac"];
    ...
    function hotspotChang(type) {
      ...
      switch (Number(type)) {
        case 3:
          document.getElementById("input-voucher").style.display =
            "block";
          break;
        case 5:
        case 2:
        case 8:
        case 15:
          document.getElementById("input-user").style.display =
            "block";
          document.getElementById("input-password").style.display =
            "block";
          break;
        case 6:
          document.getElementById("input-phone-num").style.display =
            "block";
